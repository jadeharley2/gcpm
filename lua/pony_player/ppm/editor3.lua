...
/*
	...
	*/
	...
	function mdl:LayoutEntity( )
		...
		math.Clamp(self.camang.p-y+self.mdy,-89,13)-self.camang.p, -x+self.mdx, 0)
		end
	...
	time=time+0.02
		...
		PPM.setBodygroups(PPM.editor3_pony)
		
	end  
	mdl.t =0
	mdl.backgroundmodel_sky = ClientsideModel("models/mlp/decoration/skydome.mdl") 
	mdl.backgroundmodel_sky:SetModelScale( 25,0)
	mdl.backgroundmodel_sky:SetAngles(Angle(0,30,0))
	mdl.backgroundmodel_ground = ClientsideModel("models/mlp/decoration/ground.mdl") 
	mdl.backgroundmodel_ground:SetModelScale( 25,0)
	mdl.backgroundmodel = ClientsideModel("models/mlp/decoration/building.mdl") 
