...
PPM.Pony_variables.default_pony = 
{
	...
	eyecolor_grad = { default = Vector(1,1,1)/2 },
	eyecolor_line1 = { default = Vector(1,1,1)*0.8 },
	eyecolor_line2 = { default = Vector(1,1,1)*0.9 },
...
/*
function PPM.regpvar_bool(name,default,min,max)
end
function PPM.regpvar_number(name,default,min,max)
end
function PPM.regpvar_vector(name,default,min,max)
end
*/